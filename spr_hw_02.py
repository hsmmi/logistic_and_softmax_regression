import numpy as np
from logistic_regression import MSE, MSE_prediction, accuracy, gradient_ascent_for_maximum_likelihood, one_vs_one, one_vs_rest, predict_logistic_regression, probability, sigmoid
...
theta = gradient_ascent_for_maximum_likelihood(X_train, y_train, 300, plotter= 0, printer = 0)
